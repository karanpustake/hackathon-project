...
function Nav() {
  return (
    <div> <div className='flex justify-center p-4 bg-white font-Outfit fixed w-full'>
    <div className='flex items-center justify-between gap-[100vh] '>
      ...
      <p>Safar naye Bharat ka !</p>
        ...
        <div className='flex gap-3 text-xl'>
          ...
          <p className=' cursor-pointer hover:text-slate-100 transition duration-300 hover:bg-slate-400 p-2 rounded-md'>Experiences</p>
